...
def check_allowed_values(interface_A_dict, interface_B_dict):
    # docstring
    # return list[str]: paths which don't satisfy the allowed_value constraint in
    # interface B
...
def check_compatibility(path_interface_A: str, path_interface_B: str, silent: bool):
    ...
    validate_definitions(path_interface_A, silent)
    validate_definitions(path_interface_B, silent)
    ...
    # Lastly, check for allowed_values
...
def main(path_interface_A: str, path_interface_B: str, silent: bool):
    check_compatibility(path_interface_A, path_interface_B, silent)
